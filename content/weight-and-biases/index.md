...
2. **가입하기** 버튼을 클릭합니다.
![[Pasted image 20250120153700.png]]

3. 회원 정보를 입력합니다.
![[Pasted image 20250120153831.png]]

4. 조직 이름을 입력합니다.
![[Pasted image 20250120153903.png]]

5. **W&B Models**를 선택하고, `pip install wandb`를 통해 설치합니다.
![[Pasted image 20250120154033.png]]

6. `wandb login`을 입력하고, API키를 복사해서 붙여넣습니다.
![[Pasted image 20250120155302.png]]

![[Pasted image 20250120155408.png]]

7. API가 등록되면 `wandb login`을 입력해서 로그인이 되었는지 확인합니다.
![[Pasted image 20250120155622.png]]
